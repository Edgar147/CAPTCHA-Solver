...
image_dir = "preprocessing_data/stats"
correct_count = 0
incorrect_count = 0
...
print("Correcte -> {:.2f}%".format((correct_count/100)*100))
correctResult = (correct_count/100)*100
# Open the file in "append" mode and write the value of `correct` to a new line
with open('results.txt', 'a') as file:
    file.write(str(correctResult) + '\n')
print("Incorrecte -> {:.2f}%".format((incorrect_count/100)*100))
